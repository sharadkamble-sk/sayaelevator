...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Prepare a SELECT query to fetch the user based on the provided username and password
  $stmt = $conn->prepare("SELECT * FROM registered_users WHERE username = ? AND password = ?");
...
<head>
  ...
  <title>Sign In | Saya Elevator</title>
...
<body>
  ...
  <!-- <section style="background: url('assets/img/login-bg.jpg'); height: 400px;  background-repeat: no-repeat;">
      ...
      <div class="row justify-content-sm-center h-100">
        <div
          ...
          <!-- <div class="text-center my-5">
              <img src="assets/img/login.svg" style="width: 100px;" alt="logo" width="100">
            </div> -->
  <section class="userlogin">
      ...
      <div class="card col-md-4">
        ...
        <div class="card-body">
          <form method="POST" action="login.php">
            ...
            <div class="mb-2">
              <button type="submit" class="btn btn-success col-md-12 d-grid">Login</button>
            </div>
            <!-- <div class="card-header text-center"><a href="">Don't have an account? Create One</div> -->
          </form>
        </div>
      </div>
    </div>
    ...
    <!-- <div class="card-footer py-3 border-0">
      <div class="text-center">
        Don't have an account? <a href="register.html" class="text-primary"> Create One</a>
      </div> -->
    </div>
    </div>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a href="index.html" target="_blank">Home</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="about.html" target="_blank">About us</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="services.html" target="_blank">Services</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="page-terms.html" target="_blank">Terms of service</a>
              </li>
              <li><i class="bi bi-chevron-right"></i> <a href="page-privacy.html" target="_blank">Privacy policy</a>
              </li>
            </ul>
          </div>
